...
public class StudentsResource {
  ...
  public ResponseEntity<StudentsDTO> createStudent(@PathVariable Long classroomId, @RequestBody StudentsDTO studentsDTO)
  ...
  public ResponseEntity<StudentsDTO> updateStudentEntirely(@PathVariable Long studentId, @RequestBody StudentsDTO studentsDTO)
    throws URISyntaxException {
  ...
  public ResponseEntity<StudentsDTO> updateStudent(@PathVariable Long studentId, @RequestBody StudentsDTO studentsDTO)
    throws URISyntaxException {
    log.debug("REST request to update Student : {}", studentsDTO);
    studentsDTO.setId(studentId);
  ...
  public ResponseEntity<Void> deleteStudent(@PathVariable Long studentId) {
    ...
    return ResponseEntity
      .noContent()
      .headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, ENTITY_NAME, studentId.toString()))
      .build();
  }

  private boolean isStudentDataComplete(StudentsDTO studentsDTO) {
    return (
      studentsDTO.getFirstName() != null &&

...
public class SchoolsResource {
    ...
    public ResponseEntity<SchoolsDTO> updateSchoolEntirely(@PathVariable Long schoolId, @RequestBody SchoolsDTO schoolsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<SchoolsDTO> updateSchool(@PathVariable Long schoolId, @RequestBody SchoolsDTO schoolsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<Void> deleteSchool(@PathVariable Long schoolId) {
        ...
        return ResponseEntity.noContent().headers(HeaderUtil.createEntityDeletionAlert(applicationName, true, ENTITY_NAME, schoolId.toString())).build();
    }

    private boolean isClassroomDataComplete(SchoolsDTO schoolsDTO) {
        return schoolsDTO.getName() != null &&
               schoolsDTO.getAddress() != null &&
               schoolsDTO.getPhoneNumber() != null;
    }
}
